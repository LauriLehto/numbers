        ...
        <View style={styles.container}>
          {/* <Text>{AsyncStorage.getItem('score')}</Text> */}
            <SortableList
                ...
                onChangeOrder={nextOrder=>{this.onReorder(nextOrder)}} 
            />
            <Text style={styles.answer}>{this.state.answer}</Text>
            <Button onPress={()=>this.onAnswer()} style={styles.button} title='Submit Answer'/>
        </View>
      );
    }
    ...
    render() {
      ...
      return (
        <Animated.View style={[
          ...
          <Text style={styles.text}>{newText} ({number})</Text>
        </Animated.View>
      );
    }
  }
